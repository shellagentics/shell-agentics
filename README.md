...
The terminal is an interface for a human to issue natural-ish language commands to an interpreter that orchestrates tools. Understanding the terminal deeply is understanding the design space that AI agents now inhabit.
